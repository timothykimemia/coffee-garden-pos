@php
$steps=array('Default'=>'Default','Milling'=>'Milling', 'Fortifying'=>'Fortifying');
@endphp
@extends('layouts.app')
...
{!! Form::open(['url' => action('ProductController@store'), 'method' => 'post', 
    ...
    @component('components.widget', ['class' => 'box-primary'])
      ...
      <div class="clearfix"></div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('process', __('Product process') . ':*') !!}
            {!! Form::select('process', $steps, !empty($product->process) ? $product->process : null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2', 'required']); !!}
         </div>
        </div>
