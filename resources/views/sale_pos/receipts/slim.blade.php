...
<html lang="en">
    ...
    <body>
        <div class="ticket">
                ...
                <tbody>
                	@forelse($receipt_details->lines as $line)
	                    <tr>
	                        ...
	                        @if(empty($receipt_details->hide_price))
	                        <td class="unit_price text-right">{{$line['unit_price_inc_tax']}}</td> <!-- changed on 11/08/2021 at 1231 hrs -->
	                        @if(!empty($receipt_details->item_discount_label))
								<td class="text-right">
            ...
            @endif
			@if(!empty($receipt_details->QRCODE))
			<!--<table style="!important" class="border-bottom width-100 table-f-12 mb-10">
                <thead class="border-bottom-dotted">
                    <tr>
                        <th >CODE</th>
                        <th class="price text-centered"  width="25%">
                        	RATE %
                        </th>
                        <th class="price text-right" width="25%">
                        	VATABLE AMT
                        </th>
                ...
                <tbody>
					<tr>
						<td>A</td>
						<td class="price text-centered" width="25%" >16</td>
						<td class="price text-right" width="25%" >{!! $receipt_details->VAT_A_NET !!}</td>
						<td class="price text-right" width="25%" >{!! $receipt_details->VAT_A !!}</td>
					</tr>
					<tr>
						<td>Z</td>
						<td class="price text-centered" width="25%" >0</td>
						<td class="price text-right" width="25%" >{!! $receipt_details->VAT_0 !!}</td>
						<td class="price text-right"width="25%" >0</td>
					</tr>
				</tbody>
			</table>
			-->
				<p class="centered">
					TSIN : {!! $receipt_details->TSIN !!}
					<br>
					CUIN :	{!! $receipt_details->CUIN !!}
					<br>
					CUSN : {!! $receipt_details->CUSN !!}
					<br>
					DATE : {!! $receipt_details->TDATE !!}
				</p>
				<img class="center-block" src="data:image/png;base64,{{DNS2D::getBarcodePNG($receipt_details->QRCODE, 'QRCODE', 3, 3)}}">
			@endif
