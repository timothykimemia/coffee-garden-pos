...
class TransactionUtil extends Util
{
	 ...
	 public function getReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $receipt_printer_type)
    {
        ...
        $output['TSIN'] = $transaction->TSIN;
        $output['CUSN'] = $transaction->CUSN;
        $output['CUIN'] = $transaction->CUIN;
        $output['TDATE'] = $transaction->TDATE;
        // $output['VAT_A_NET'] = $transaction->VAT_A_NET;
        // $output['VAT_A'] = $transaction->VAT_A;
        // $output['VAT_0'] = $transaction->VAT_0;

        $output['QRCODE'] = !empty($transaction->QRCODE)?$transaction->QRCODE:" ";
        // $output['TSIN'] = !empty($transaction->TSIN)?$transaction->TSIN:" ";
        // $output['CUSN'] = !empty($transaction->CUSN)?$transaction->CUSN:" ";
        // $output['CUIN'] = !empty($transaction->CUIN)?$transaction->CUIN:" ";
        // $output['TDATE'] = !empty($transaction->TDATE)?$transaction->TDATE:" ";
        $output['VAT_A_NET'] = $transaction->VAT_A_NET;
        $output['VAT_A'] = $transaction->VAT_A;
        $output['VAT_0'] = $transaction->VAT_0;
    ...
    public function getReceiptDetails2($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $receipt_printer_type)
    {
        $il = $invoice_layout;
