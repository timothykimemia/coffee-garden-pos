			...
			<div class="row">
			    <div class="col-md-3">
					<div class="form-group">
						...
						<div class="input-group">
							@php
								$labor_cost = $ingredient->labor_cost ?? 0.00;
							@endphp
							{!! Form::text('labor_cost', @num_format($labor_cost), ['id' => 'labor_cost', 'class' => "form-control"]); !!}
							<span class="input-group-addon">
								{{$currency_details->symbol}}
							</span>
						</div>
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<div class="input-group">
							@php
								$bag_cost = $ingredient->bag_cost ?? 0.00;
							@endphp
							{!! Form::text('bag_cost', @num_format($bag_cost), ['id' => 'bag_cost', 'class' => "form-control"]); !!}
							<span class="input-group-addon">
								{{$currency_details->symbol}}
							</span>
						</div>
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<div class="input-group">
							...
							@endphp
							{!! Form::text('electricity_cost', @num_format($electricity_cost), ['id' => 'electricity_cost', 'class' => "form-control"]); !!}
							<span class="input-group-addon">
								{{$currency_details->symbol}}
							</span>
						</div>
