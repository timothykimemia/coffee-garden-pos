...
<section class="content">
	...
	@component('components.widget', ['class' => 'box-solid', 'title' => __('manufacturing::lang.ingredients')])
		...
		<div class="row mt-5">
		    <div class="col-md-3">
				<div class="form-group">
					{!! Form::label('manufactured_quantity','Manufactured Quantity :') !!}
					<div class="input_inline">
						{!! Form::text('manufactured_quantity', 0, ['class' => 'form-control input_number', 'readonly'=>'readonly', 'id' => 'manufactured_quantity'] ); !!}
			...
			<div class="col-md-3">
				<div class="form-group">
					{!! Form::label('previously_unpacked_quantity','Previous Unpacked Quantity :') !!}
					<div class="input_inline">
						{!! Form::text('previously_unpacked_quantity', 0, ['class' => 'form-control input_number', 'readonly'=>'readonly', 'id' => 'previously_unpacked_quantity'] ); !!}
						<span class="input-group-addon" id="">Kilograms</span>
						<input name="total_unpacked_cost" type="hidden" style='border: #C0C0C0;' value="">
					</div>
				</div>
		...
		<div class="row mt-5">
			...
			<div class="col-md-3">
				<div class="form-group">
					{!! Form::label('unpacked_quantity','Unpacked Quantity :') !!}
					<div class="input_inline">
						{!! Form::text('unpacked_quantity', 0, ['class' => 'form-control input_number', 'readonly'=>'readonly', 'id' => 'unpacked_quantity'] ); !!}
						<span class="input-group-addon" id="">Kilograms</span>
						<input name="total_unpacked_cost" type="hidden" style='border: #C0C0C0;' value="">
					</div>
					<p><strong>
					Total to Pack:
						...
						<input name="total_to_pack" id="total_to_pack" type="number" value="0" style='border: #C0C0C0; width:70px; ' readonly></p></strong>
				</div>
			</div>
			<!-- 10kg -->
			<div class="col-md-3">
				<div class="form-group">
					{!! Form::label('tenkg_packaging_quantity','10kg Bags :') !!}
					<div class="input_inline">
						{!! Form::text('tenkg_packaging_quantity', 0, ['class' => 'form-control input_number', 'id' => 'ten_quantity']); !!}
					...
					<p><strong>
					Total 10kg Bags in kg:
						
						<input name="total_10_kgs" id="total_10_kgs" type="number" value="0" style='border: #C0C0C0; width:70px; ' readonly></p></strong>
				</div>
			</div>
			<!-- 20kg -->
			<div class="col-md-3">
				<div class="form-group">
					{!! Form::label('twentykg_packaging_quantity','20kg Bags :') !!}
					<div class="input_inline">
						{!! Form::text('twentykg_packaging_quantity', 0, ['class' => 'form-control input_number', 'id' => 'twenty_quantity']); !!}
						<span class="input-group-addon" id="">Bags</span>
					</div>
					<p><strong>
					Total 20kg Bags in kg:
						
						<input name="total_20_kgs" id="total_20_kgs" type="number" value="0" style='border: #C0C0C0; width:70px; ' readonly></p></strong>
				</div>
			</div>
			<!-- 50kg -->
			<div class="col-md-3">
				<div class="form-group">
					{!! Form::label('fiftykg_packaging_quantity','50kg Bags :') !!}
					<div class="input_inline">
						{!! Form::text('fiftykg_packaging_quantity', 0, ['class' => 'form-control input_number', 'id' => 'fifty_quantity']); !!}
						<span class="input-group-addon" id="">Bags</span>
					</div>
					<p><strong>
					Total 50kg Bags in kg:
						
						<input name="total_50_kgs" id="total_50_kgs" type="number" value="0" style='border: #C0C0C0; width:70px; ' readonly></p></strong>
				</div>
			</div>
			<!-- 70kg -->
			<div class="col-md-3">
				<div class="form-group">
					{!! Form::label('seventykg_packaging_quantity','70kg Bags :') !!}
					<div class="input_inline">
						{!! Form::text('seventykg_packaging_quantity', 0, ['class' => 'form-control input_number', 'id' => 'seventy_quantity']); !!}
						<span class="input-group-addon" id="">Bags</span>
					</div>
					<p><strong>
					Total 70kg Bags in kg:
						
						<input name="total_70_kgs" id="total_70_kgs" type="number" value="0" style='border: #C0C0C0; width:70px; ' readonly></p></strong>
				</div>
			</div>
		</div>
		<div class="row">
