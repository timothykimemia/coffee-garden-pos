...
<section class="content">
	...
	<div class="box box-solid">
		<div class="box-body">
			...
			<!-- New additions to cater for extra costs -->
			<div class="row">
			    <div class="col-md-3">
					<div class="form-group">
						{!! Form::label('labor_cost', __('Labor Cost').':') !!}
						<div class="input-group">
							{!! Form::text('labor_cost', !empty($recipe->labor_cost) ? @num_format($recipe->labor_cost) : 0, ['id' => 'labor_cost', 'class' => "form-control"]); !!}
							<span class="input-group-addon">
								{{$currency_details->symbol}}
							</span>
						</div>
				...
				<div class="col-md-3">
					<div class="form-group">
						{!! Form::label('bag_cost', __('Bag Cost').':') !!}
						<div class="input-group">
							{!! Form::text('bag_cost',!empty($recipe->bag_cost) ? @num_format($recipe->bag_cost) : 0, ['id' => 'bag_cost', 'class' => "form-control"]); !!}
							<span class="input-group-addon">
								{{$currency_details->symbol}}
							</span>
						</div>
				...
				<div class="col-md-3">
					<div class="form-group">
						{!! Form::label('electricity_cost', __('Electricity Cost').':') !!}
						<div class="input-group">
							@php
								$electricity_cost = $ingredient->electricity_cost ?? 0.00;
							@endphp
							{!! Form::text('electricity_cost',!empty($recipe->electricity_cost) ? @num_format($recipe->electricity_cost) : 0, ['id' => 'electricity_cost', 'class' => "form-control"]); !!}
							<span class="input-group-addon">
								{{$currency_details->symbol}}
							</span>
						</div>
